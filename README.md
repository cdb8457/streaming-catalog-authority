...
**All four of these commands take turns in one backup destination.** `ops:complete-backup`,
`ops:complete-restore`, `ops:backup-retention` and `ops:safety-set-lifecycle` serialise **one at a time per
