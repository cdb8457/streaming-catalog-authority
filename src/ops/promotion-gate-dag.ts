...
const NODES: readonly GateNode[] = [
  ...
  { id: 'review-authorization', test: 'test/promotion-review-authorization.ts', dependsOn: ['terminal-readiness-v2', 'terminal-closure', 'commit-range-closure', 'transcript-verifier', 'review-matrix'], blockers: ['READINESS_NOT_CONFIRMED', 'REVIEW_MATRIX_NOT_READY', 'TERMINAL_CLOSURE_NOT_BOUND', 'CONTEXT_COMMITS_MISMATCH', 'CONTEXT_REQUIRED_TESTS_MISMATCH', 'COMPONENT_DIGEST_MISMATCH'] },
