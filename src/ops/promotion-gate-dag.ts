...
const NODES: readonly GateNode[] = [
  ...
  { id: 'context-consistency-audit', test: 'test/promotion-context-consistency-audit.ts', dependsOn: ['merge-readiness', 'reviewer-pack', 'commit-range-closure', 'transcript-verifier', 'review-matrix'], blockers: ['COMPONENT_UNVERIFIED', 'CONTEXT_HEAD_INCONSISTENT', 'CONTEXT_COMMITS_INCONSISTENT', 'CONTEXT_TESTS_INCONSISTENT', 'INSUFFICIENT_CONTEXT_COMPONENTS'] },
  { id: 'closure-summary-v3', test: 'test/promotion-closure-summary-v3.ts', dependsOn: ['review-authorization', 'coordinator-readiness'], blockers: ['UNBOUND_TERMINAL_CONTEXT', 'UNBOUND_COORDINATOR_CONTEXT', 'OBSERVED_STATE_MISSING', 'OBSERVED_STATE_UNBOUND', 'COMPONENT_DIGEST_UNVERIFIED', 'LIVE_BOUNDARY_ESCAPE'] },
  { id: 'closure-input-bundle-audit', test: 'test/promotion-closure-input-bundle-audit.ts', dependsOn: ['review-authorization', 'terminal-readiness-v2', 'coordinator-readiness'], blockers: ['BUNDLE_ROOT_UNRESOLVED', 'DUPLICATE_REPORT_ID', 'NO_REPORTS'] },
  { id: 'approval-request-packet', test: 'test/promotion-approval-request-packet.ts', dependsOn: ['review-authorization'], blockers: ['REVIEW_AUTHORIZATION_MISSING', 'REVIEW_AUTHORIZATION_NOT_AUTHORITATIVE', 'APPROVAL_CLAIM_PRESENT'] },
  { id: 'live-preflight-plan', test: 'test/promotion-live-preflight-plan.ts', dependsOn: [], blockers: ['PLAN_MISSING', 'ITEM_NOT_PENDING', 'SOURCE_DIGEST_MISSING', 'DESTINATION_DIGEST_MISSING', 'LIVE_SURFACE_IN_PLAN'] },
  { id: 'no-live-authorization-guard', test: 'test/promotion-no-live-authorization-guard.ts', dependsOn: [], blockers: ['LIVE_AUTHORIZATION_CLAIMED', 'NO_ARTIFACTS'] },
  { id: 'review-checklist-v2', test: 'test/promotion-review-checklist-v2.ts', dependsOn: ['closure-summary-v3', 'closure-input-bundle-audit'], blockers: ['CLOSURE_SUMMARY_NOT_READY', 'BUNDLE_AUDIT_NOT_VERIFIED', 'LIVE_BOUNDARY_SUITE_MISSING'] },
  { id: 'operator-acceptance-trace', test: 'test/promotion-operator-acceptance-trace.ts', dependsOn: ['approval-request-packet', 'live-preflight-plan', 'no-live-authorization-guard', 'review-checklist-v2'], blockers: ['APPROVAL_REQUEST_NOT_READY', 'LIVE_PREFLIGHT_NOT_VALID', 'LIVE_PREFLIGHT_ITEM_NOT_PENDING', 'NO_LIVE_GUARD_VIOLATED', 'CHECKLIST_NOT_READY', 'COMPONENT_DIGEST_UNVERIFIED', 'LIVE_AUTHORIZATION_CLAIMED'] },
  { id: 'guard-adversarial-corpus-v2', test: 'test/promotion-guard-adversarial-corpus-v2.ts', dependsOn: [], blockers: ['GUARD_CORPUS_V2_BREACHED'] },
  { id: 'final-coordinator-readiness-bundle', test: 'test/promotion-final-coordinator-readiness-bundle.ts', dependsOn: ['operator-acceptance-trace', 'no-live-authorization-guard', 'live-preflight-plan', 'approval-request-packet', 'review-checklist-v2', 'self-digest-verifier'], blockers: ['ACCEPTANCE_TRACE_NOT_READY', 'SELF_DIGEST_NOT_VERIFIED', 'REDACTION_NOT_PROVEN', 'OBSERVED_STATE_REQUIREMENT_MISSING', 'LIVE_AUTHORIZATION_CLAIMED', 'ACCEPTANCE_TRACE_COMPONENT_MISMATCH', 'REVIEWED_COMMIT_MISMATCH', 'SELF_DIGEST_BINDING_MISMATCH'] },
  { id: 'review-authorization', test: 'test/promotion-review-authorization.ts', dependsOn: ['terminal-readiness-v2', 'terminal-closure', 'commit-range-closure', 'transcript-verifier', 'review-matrix'], blockers: ['READINESS_NOT_CONFIRMED', 'REVIEW_MATRIX_NOT_READY', 'TERMINAL_CLOSURE_NOT_BOUND', 'CONTEXT_COMMITS_MISMATCH', 'CONTEXT_TRANSCRIPT_HEAD_MISMATCH', 'COMPONENT_DIGEST_MISMATCH'] },
