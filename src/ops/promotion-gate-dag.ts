...
const NODES: readonly GateNode[] = [
  ...
  { id: 'final-coordinator-readiness-bundle', test: 'test/promotion-final-coordinator-readiness-bundle.ts', dependsOn: ['operator-acceptance-trace', 'no-live-authorization-guard', 'live-preflight-plan', 'approval-request-packet', 'review-checklist-v2', 'self-digest-verifier'], blockers: ['ACCEPTANCE_TRACE_NOT_READY', 'SELF_DIGEST_NOT_VERIFIED', 'REDACTION_NOT_PROVEN', 'OBSERVED_STATE_REQUIREMENT_MISSING', 'LIVE_AUTHORIZATION_CLAIMED'] },
