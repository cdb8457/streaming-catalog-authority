...
const NODES: readonly GateNode[] = [
  ...
  { id: 'closure-input-bundle-audit', test: 'test/promotion-closure-input-bundle-audit.ts', dependsOn: ['review-authorization', 'terminal-readiness-v2', 'coordinator-readiness'], blockers: ['BUNDLE_ROOT_UNRESOLVED', 'NO_REPORTS'] },
