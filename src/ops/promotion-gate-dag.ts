...
const NODES: readonly GateNode[] = [
  ...
  { id: 'closure-summary-v3', test: 'test/promotion-closure-summary-v3.ts', dependsOn: ['review-authorization', 'coordinator-readiness'], blockers: ['UNBOUND_TERMINAL_CONTEXT', 'UNBOUND_COORDINATOR_CONTEXT', 'OBSERVED_STATE_MISSING', 'COMPONENT_DIGEST_UNVERIFIED', 'LIVE_BOUNDARY_ESCAPE'] },
