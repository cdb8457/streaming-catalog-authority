...
const SCHEMAS: Readonly<Record<string, ReportSchema>> = {
  ...
  'phase-230-promotion-merge-review-evidence-pack': { keys: [...BASE, 'overall', 'components', 'bindings', 'provenance', 'blockers', 'disclaimers', 'packDigest'], overall: ['REVIEWER_PACK_READY', 'REVIEWER_PACK_BLOCKED'], digestField: 'packDigest' },
