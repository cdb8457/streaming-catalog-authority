...
test('source and docs preserve post-switch review boundary', () => {
  ...
  assert((AGGREGATE_SUITE_COMMAND ?? '').includes('test/unraid-production-switch-execution-packet.ts && tsx test/unraid-post-switch-evidence-review.ts'), 'aggregate order');
