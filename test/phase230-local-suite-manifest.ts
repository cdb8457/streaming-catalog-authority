...
const LOCAL_SUITES = [
  ...
  'test/promotion-review-bundle.ts',
  ...
  'test/promotion-provenance-diff.ts',
  ...
  'test/promotion-review-automation.ts',
  ...
  'test/promotion-report-schema.ts',
  'test/promotion-boundary-audit.ts',
  'test/promotion-coordinator-readiness.ts',
  ...
  'test/promotion-approval-request-packet.ts',
  'test/promotion-live-preflight-plan.ts',
  'test/promotion-no-live-authorization-guard.ts',
  'test/promotion-review-checklist-v2.ts',
