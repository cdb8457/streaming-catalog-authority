...
/**
 * Phase 3 Stage 3.4 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â static structural checks for the deployment artifacts.
 *
...
test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â defines postgres + one-shot ops services', () => {
...
test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â postgres has a pg_isready healthcheck', () => {
  assert(/healthcheck:/.test(compose) && /pg_isready/.test(compose), 'pg_isready healthcheck present');
});

test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â keystore is a SEPARATE volume from pgdata and backups', () => {
...
test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â secrets delivered via *_FILE (no inline secret values)', () => {
...
test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â CLI pattern: no ports / no HTTP daemon', () => {
  assert(!/ports:/.test(compose), 'no published ports (not an HTTP service)');
  assert(!/(expose|EXPOSE)/.test(compose), 'no exposed port');
});

test('unraid compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â single canonical file with production binds and intentional app port', () => {
...
test('unraid runtime compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â launcher-ready image mode with no build context', () => {
...
test('compose ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `docker compose run ops` invocations must NOT double-prefix npm run', () => {
...
test('package.json ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ops + deploy scripts wired; no HTTP framework dep', () => {
...
test('adapter boundary ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no network/provider leakage in src/core/adapters (Phase 7)', () => {
...
test('erasure policy ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 9 publish module clean; doc + suites wired', () => {
...
test('jellyfin adapter ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 10 fake/local only: no network, no OTHER providers; doc + suites wired', () => {
...
test('jellyfin HTTP (Phase 11) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â injected-fetch only in core; gated; smoke opt-in + out of CI', () => {
  const dir = fileURLToPath(new URL('../src/core/adapters/jellyfin', import.meta.url));
  // the core adapter must NEVER reference a bare/global fetch ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â network only flows via the injected seam.
...
test('publish outbox ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 12 doc + suites wired; create only via the outbox', () => {
  ...
  // the bare create stays disabled ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the ONLY real-create path is the outbox (createTaggedCollection).
...
test('jellyfin smoke ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 13 validation: doc + suite wired; globalThis.fetch limited to operator CLIs', () => {
...
test('jellyfin mapping ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 14 pagination is present + bounded; doc wired', () => {
...
test('production readiness gate ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 22 consolidates the 9 criteria + statuses; no stale refs', () => {
...
test('docs ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â PHASE_3_DEPLOYMENT covers Unraid, *_FILE, keystore separation, operator age', () => {
...
test('docs ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â production-gate wording is accurate (memory guard is CLOSED/enforced)', () => {
  const doc = read('docs/PHASE_3_DEPLOYMENT.md');
...
test('unraid template ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â one-shot, no ports, *_FILE secrets, separate keystore (Stage 5.3)', () => {
...
test('ops lifecycle ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 6 CLIs + docs are wired (version/verify/rehearse/doctor --json)', () => {
...
test('Phase 120 Unraid operator readiness bundle is offline planning only', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/o5-kek-final-authorization.ts && tsx test/o5-disposition.ts && tsx test/launch-readiness-pass.ts && tsx test/launch-package.ts && tsx test/launch-candidate-dry-run.ts && tsx test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 200 launch readiness pass records ready with accepted warning', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/o5-disposition.ts && tsx test/launch-readiness-pass.ts && tsx test/launch-package.ts && tsx test/launch-candidate-dry-run.ts && tsx test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 201 launch package exposes operator handoff without scope expansion', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/launch-readiness-pass.ts && tsx test/launch-package.ts && tsx test/launch-candidate-dry-run.ts && tsx test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 202 launch candidate consumer dry run preserves the public launch path', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/launch-package.ts && tsx test/launch-candidate-dry-run.ts && tsx test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 203 media-player boundary selection chooses Jellyfin without enabling runtime', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/launch-candidate-dry-run.ts && tsx test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 204 Jellyfin read-only smoke is guarded and write-free', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/media-player-boundary.ts && tsx test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 205 Jellyfin read-only mapping emits counts-only evidence', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-readonly-smoke.ts && tsx test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 206 Jellyfin disposable write proof is gated and self-cleaning', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-readonly-mapping.ts && tsx test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 207 Jellyfin evidence review decision defers launch pending live evidence', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-disposable-write.ts && tsx test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 208 existing Jellyfin live evidence preflight forbids installs and port collisions', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-evidence-review-decision.ts && tsx test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 209 Jellyfin live read-only smoke runner is secret-file-only and write-free', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-live-evidence-preflight.ts && tsx test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 210 Jellyfin live evidence capture preflight records missing secret without live smoke', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-live-readonly-smoke-runner.ts && tsx test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 211 Jellyfin live evidence capture command saves redaction-safe smoke JSON', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-live-evidence-capture-preflight.ts && tsx test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
...
test('Phase 212 Jellyfin secret readiness gate validates secret file without live contact', () => {
  ...
  assert(
    (pkg.scripts.test ?? '').includes('test/jellyfin-live-evidence-capture.ts && tsx test/jellyfin-secret-readiness.ts && tsx test/unraid-operator-readiness-bundle.ts'),
