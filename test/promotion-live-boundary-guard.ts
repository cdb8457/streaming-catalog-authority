...
const LOCAL_TOOL_SOURCES = [
  ...
  'src/ops/promotion-provenance-ledger.ts', 'src/ops/promotion-provenance-ledger-cli.ts',  'src/ops/promotion-gate-dag.ts', 'src/ops/promotion-gate-dag-cli.ts',  'src/ops/promotion-changelog.ts', 'src/ops/promotion-changelog-cli.ts',  'src/ops/promotion-archive-manifest.ts', 'src/ops/promotion-archive-manifest-cli.ts',
];
...
const LOCAL_TOOL_DOCS = [
  ...
  'docs/PHASE_230_PROMOTION_PROVENANCE_LEDGER.md',  'docs/PHASE_230_PROMOTION_GATE_DAG.md',  'docs/PHASE_230_PROMOTION_CHANGELOG.md',  'docs/PHASE_230_PROMOTION_ARCHIVE_MANIFEST.md',
];
