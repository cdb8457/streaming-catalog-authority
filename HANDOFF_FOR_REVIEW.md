...
Current state: **typecheck clean, 21/21 tests pass** against embedded PostgreSQL 16.14.
History: round 1 = 14 tests (TS-centric); round 2 = 19 (typed gate, tombstone, locks,
roles); round 3 = 21 (**authority moved into the database**). See `REMEDIATION.md` for the
finding-by-finding trail.
