...
echo "gates, G27s three-server half has run 3/3 on a real Unraid host too, and no real provider endpoint"
echo "has ever been contacted, so Phase 1 remains open. What has been run is"
echo "docs/PROJECTION_PHASE_1_ACCEPTANCE_PLAN.md section 6.1."
